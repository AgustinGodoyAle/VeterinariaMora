...
switch ($_GET["op"]) {
	case 'guardaryeditar':
		...
		else
		{
			...
			{
				//la variable imagen va a almacenar el nombre de la imagen + la extension
				//el nombre de la imagen se va a renombrar utilizando la funcion microtime
				$imagen= round(microtime(true)) . '.' . end($ext);
				//voy a subir el archivo a nuetro sitema
